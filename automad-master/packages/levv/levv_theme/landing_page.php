...
<main class="w-full flex flex-col items-center">
	<div id="levv-question" class="w-full flex flex-col items-center fixed mt-32 bg-levv-klei-header-background">
		<h1 class="text-2xl lg:text-5xl p-2 lg:p-0"><span>Welke uitdaging wil je aangaan </span><span class="text-levv-wijnrood font-bold text-3xl lg:text-6xl">met Levv?</span></h1>

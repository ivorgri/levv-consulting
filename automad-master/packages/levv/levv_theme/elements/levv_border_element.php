<div class="levv-border-element">
  ...
  <div class="stroke-[10]" style="display:none"></div>
  <div class="stroke-[20]" style="display:none"></div>
  <div class="md:stroke-[20]" style="display:none"></div>
  <div class="tl-corner">
    ...
    <@ if @{ :element_contains_js } @>
      :class="levvBorderElement.value === store.selectedLevvBorderElement ? 'stroke-@{ :element_text_color_active } @{ :element_border_width }' : 'stroke-@{ :element_border_color } @{ :element_border_width }'"
    <@ end @>
    width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <path d="M 50 100 A 50 50, 0, 0, 1, 100 50" fill="transparent"/>
    </svg>
  </div>
  <div class="tl-line">
    <svg class="stroke-@{ :element_border_color } group-hover:stroke-@{ :element_border_color_hover } group-focus:stroke-@{ :element_border_color_hover }
    ...
    <@ end @>
    width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <path d="M 0 50 h 100" fill="transparent"/>
    </svg>
  </div>
  <div class="tc-line">
    <svg class="stroke-@{ :element_border_color } group-hover:stroke-@{ :element_border_color_hover } group-focus:stroke-@{ :element_border_color_hover }
    ...
    <@ end @>
    width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <path d="M 0 50 h 25" fill="transparent"/>
      <path d="M 25 50 h 50" fill="transparent" stroke="transparent"/>
      <path d="M 75 50 h 25" fill="transparent"/>
    </svg>
  </div>
  <div class="tr-line">
    <svg class="stroke-@{ :element_border_color } group-hover:stroke-@{ :element_border_color_hover } group-focus:stroke-@{ :element_border_color_hover }
  ...
  <div class="tr-corner">
    ...
    <@ end @>
    width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <path d="M 0 50 h 50 v 50" fill="transparent"/>
    </svg>
  </div>
  <div class="ml-line">
    <svg class="stroke-@{ :element_border_color } group-hover:stroke-@{ :element_border_color_hover } group-focus:stroke-@{ :element_border_color_hover }
    ...
    <@ end @>
    width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <path d="M 50 0 V 100" fill="transparent"/>
    </svg>
  </div>
  <div class="mc-content text-base
  <@ if @{ :element_text_color_hover }@>group-hover:text-@{ :element_text_color_hover } group-focus:text-@{ :element_text_color_hover }<@ end @>
  <@ if @{ :element_content_padding }@>@{ :element_content_padding }<@ end @>
  ...
  <div class="bl-corner">
    ...
    <@ end @>
    width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <path d="M 50 0 v 50 h 50" fill="transparent"/>
    </svg>
  </div>
  <div class="bl-line">
    <svg class="stroke-@{ :element_border_color } group-hover:stroke-@{ :element_border_color_hover } group-focus:stroke-@{ :element_border_color_hover }
  ...
  <div class="br-corner">
    ...
    <@ end @>
    width="100%" height="100%" preserveAspectRatio="none" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
      <path d="M 50 0 A 50 50, 0, 0, 1, 0 50" fill="transparent"/>
    </svg>
  </div>
</div>
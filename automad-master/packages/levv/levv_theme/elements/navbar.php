...
<nav id="levv-nav-bar" class="levv-nav-bar-closed grid fixed top-0 right-0 z-50 text-levv-korenblauw p-2 md:p-6 ">
    ...
    <ul tabindex="0" class="levv-menu-opened hidden col-start-1 col-span-3 row-start-2 row-span-1 flex-row gap-2 md:gap-4 lg:gap-6 justify-self-center self-center flex-wrap content-around justify-center">
        <@ newPagelist { 
            excludeHidden: true
        } @>
        <@~ foreach in pagelist ~@>

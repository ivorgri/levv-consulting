...
<nav id="levv-nav-bar" class="levv-nav-bar-closed grid fixed top-0 right-0 z-50 bg-levv-klei-background text-levv-korenblauw p-2 md:p-6">
    ...
    <ul tabindex="0" class="levv-menu-opened hidden col-start-1 col-span-3 row-start-2 row-span-1 flex-row gap-2 md:gap-4 lg:gap-6 justify-self-center self-center flex-wrap content-around">
        <@ newPagelist { 
            excludeHidden: true
        } @>
        <@~ foreach in pagelist ~@>
            <li class="group text-lg md:text-3xl lg:text-5xl lowercase font-semibold grid grid-cols-levv-menu-item grid-rows-levv-menu-item transition ease-in-out hover:cursor-pointer hover:scale-105 focus:cursor-pointer focus:scale-105 grow">
    ...
    <div class="levv-menu-opened hidden col-start-1 col-span-3 row-start-3 row-span-1 justify-self-center w-full flex-col">
